...
server_specific_path_extra = 'mmdet3d_cmt/'
...
#     step_ratio_up=0.4)
# total_epochs = 2
evaluation = dict(interval=1, min_gt_count=1)
...
custom_imports = dict(
    imports=['projects.cmt.hooks.disable_gt_sampling', 'projects.cmt.hooks.force_stop','projects.cmt.hooks.feddyn_hook'], 
    allow_failed_imports=False)

custom_hooks = [
    dict(
        type='DisableGTImportanceHook',
        disable_after_epoch=30  # Turns off at the start of Epoch 31 (for 40 epoch federal training)
    ),
    # Add this new hook:
    dict(
        type='ForceStopHook',
